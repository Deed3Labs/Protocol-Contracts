           ...
           <div className="md:col-span-4 space-y-6">
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/20 rounded border border-zinc-200 dark:border-zinc-800/50 p-1">
                  <div className="p-4">
                    <div className="flex items-center gap-2.5 mb-0.5">
                      ...
                      <div>
                        <h2 className="text-lg font-normal text-black dark:text-white">Linked Accounts</h2>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/20 rounded border border-zinc-200 dark:border-zinc-800/50 p-1">
                  <div className="p-4 flex items-center justify-between">
                    <h2 className="text-xl font-normal text-black dark:text-white">Portfolio</h2>
              ...
              <div className="bg-zinc-50 dark:bg-zinc-900/20 rounded border border-zinc-200 dark:border-zinc-800/50 p-1">
                  <div className="p-4 flex items-center justify-between">
                    <h2 className="text-xl font-normal text-black dark:text-white">Activity</h2>
                    <button 
                      onClick={refreshAll}
