  ...
  return (
    <div className="px-3 pb-3 space-y-2.5 border-t border-zinc-200 dark:border-zinc-800 mt-2 pt-3">
      ...
      <div className="flex gap-2 pt-2">
        <button className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white text-xs font-medium py-2 px-3 rounded-lg hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">
          Buy
        </button>
        <button className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white text-xs font-medium py-2 px-3 rounded-lg hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors">
          Sell
        </button>
        <button className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-black dark:text-white text-xs font-medium py-2 px-3 rounded-lg hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors flex items-center justify-center gap-1">
          More
