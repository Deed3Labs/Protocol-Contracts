...
import { X, ChevronRight, Box, Send, ArrowRightLeft, GitMerge } from 'lucide-react';
  ...
  const actions = [
    {
      ...
      description: 'Mint a T-Deed or wrap an existing asset',
      icon: Box,
      delay: 0.1,
    },
    {
      id: 'send',
      title: 'Send Funds',
      description: 'Transfer crypto or cash to another wallet',
      icon: Send,
      delay: 0.15,
    },
    {
      id: 'swap',
      title: 'Swap & Trade',
      description: 'Exchange assets instantly across markets',
      icon: ArrowRightLeft,
      delay: 0.2,
    },
    {
      id: 'bridge',
      title: 'Bridge Assets',
      description: 'Move funds between different networks',
      icon: GitMerge,
      delay: 0.25,
    },
  ];
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 pb-2">
              <div>
                <h2 className="text-2xl font-light text-zinc-900 dark:text-white tracking-tight">Quick Actions</h2>
                <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">What would you like to do?</p>
              </div>
              <button 
                onClick={onClose}
              ...
              {actions.map((action) => (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center shrink-0 group-hover:bg-white dark:group-hover:bg-black group-hover:shadow-sm transition-all border border-transparent group-hover:border-zinc-200 dark:group-hover:border-zinc-800">
                    <action.icon className="w-5 h-5 text-zinc-900 dark:text-zinc-100" />
                  </div>
            ...
            <div className="p-4 pt-3 border-t border-zinc-100 dark:border-zinc-800/50 bg-zinc-50 dark:bg-zinc-900/30 text-center">
              <p className="text-[11px] text-zinc-400 dark:text-zinc-500 max-w-xs mx-auto leading-relaxed">
                Transaction fees and processing times may vary based on network conditions.
              </p>
            </div>
          </motion.div>
        </div>
