      ...
      <main className="pt-24 pb-28 container mx-auto max-w-7xl md:pt-32">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
           ...
           <div className="md:col-span-8 space-y-10">
              ...
              {/* Search & Filter Bar */}
              <div className="sticky top-17 md:top-20 z-30 bg-white/80 dark:bg-[#0e0e0e]/80 backdrop-blur-md py-4 -mt-3 -mx-4 px-4 md:mx-0 md:px-0 border-b border-zinc-100 dark:border-zinc-800/50">
