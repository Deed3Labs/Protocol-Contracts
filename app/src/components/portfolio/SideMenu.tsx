...
const SideMenu = ({ isOpen, onClose, user }: { isOpen: boolean; onClose: () => void; user: any; totalValue: number }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex">
      ...
      {/* Menu Panel */}
      <div className="relative w-full max-w-[320px] bg-white dark:bg-[#0e0e0e] h-full p-6 flex flex-col animate-slide-in-left border-r border-zinc-200 dark:border-zinc-800 shadow-2xl">
