...
export default function CTAStack() {
  ...
  return (
    <div className="relative w-full h-[240px]">
      ...
      {/* Counter Badge */}
      {cards.length > 0 && (
        <div className="absolute -top-3 -right-3 z-20 w-8 h-8 bg-blue-600 dark:bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg border-2 border-white dark:border-[#0e0e0e] animate-in zoom-in duration-300">
          {cards.length}
        </div>
      )}
    </div>
