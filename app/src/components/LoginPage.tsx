  ...
  return (
    <div className="min-h-screen bg-[#0e0e0e] text-white font-sans relative overflow-hidden flex flex-col md:justify-center">
      ...
      <div 
        ...
        style={{
          background: "linear-gradient(135deg, #f4f4f5 0%, #f4f4f5 30%, #0e0e0e 50%, #f4f4f5 70%, #f4f4f5 100%)",
      ...
      {/* Main Content */}
      <main className="relative z-10 pt-24 pb-28 md:pt-0 md:pb-0 container mx-auto max-w-full px-4 md:px-6 flex-1 flex items-center">
