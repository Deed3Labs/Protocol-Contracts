      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md max-h-[90vh] overflow-hidden">
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg mb-4">
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {activeTab === 'settings' && (
                <div className="space-y-3">
                  ...
                  <Separator />
                  <Button variant="ghost" className="w-full justify-start text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300">
