...
import { ReturnView, IncomeView, AccountValueView, AllocationView } from '@/components/portfolio/TabViews';
...
import CTAStack from '@/components/portfolio/CTAStack';
...
export default function BrokerageHome() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0e0e0e] text-black dark:text-white font-sans pb-20 md:pb-0 transition-colors duration-200">
      ...
      {/* Main Content */}
      <main className="pt-24 pb-28 container md:pt-32">
