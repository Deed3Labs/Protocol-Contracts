...
describe('the migration runner', () => {
  test('applies every migration once, in order', async () => {
    ...
    expect(all.map((m) => m.version)).toEqual(['0001_merchant_shop', '0002_commerce', '0003_payments', '0004_ledger', '0005_connector_status_and_event_retry', '0006_card_payments', '0007_checkout']);
