  ...
  return (
    <div className={containerClass}>
      <div className={contentClass}>
        {/* Header */}
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-black/10 dark:border-white/10">
        ...
        <div className="p-4 md:p-8 space-y-6 md:space-y-8">
          ...
          <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm overflow-hidden">
            <CardContent className="p-0">
              <div className="relative">
                {isLoadingMetadata ? (
                  <div className="w-full h-60 md:h-80 lg:h-96 bg-gray-200 dark:bg-gray-800 animate-pulse flex items-center justify-center">
                    <div className="text-center">
                      <ImageIcon className="w-8 h-8 md:w-12 md:h-12 text-gray-400 mx-auto mb-2" />
                      <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">Loading images...</p>
                    </div>
                  </div>
                ) : images.length > 0 ? (
                  <>
                    ...
                    />
                    <div className="hidden w-full h-60 md:h-80 lg:h-96 bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
                      <div className="text-center">
                        <ImageIcon className="w-8 h-8 md:w-12 md:h-12 text-gray-400 mx-auto mb-2" />
                        <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">Image failed to load</p>
                      </div>
                    </div>
                  </>
                ) : (
                  <div className="w-full h-60 md:h-80 lg:h-96 bg-gray-200 dark:bg-gray-800 flex items-center justify-center">
                    <div className="text-center">
                      <AlertCircle className="w-8 h-8 md:w-12 md:h-12 text-gray-400 mx-auto mb-2" />
                      <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">No images found</p>
                      <p className="text-xs md:text-sm text-gray-400 dark:text-gray-500">This T-Deed doesn't have any associated images</p>
                    </div>
                  </div>
                )}
          ...
          <Tabs defaultValue="overview" className="w-full">
                ...
                <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      <div className="p-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                        <Tag className="w-4 h-4 md:w-5 md:h-5 text-gray-600 dark:text-gray-400" />
                      </div>
                      <div>
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Asset Type</p>
                        <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white">{assetTypeLabel}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      ...
                      <div>
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Minted</p>
                        <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white">Recently</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                  <CardContent className="p-4 md:p-6">
                    <div className="flex items-center space-x-2 md:space-x-3">
                      ...
                      <div>
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Estimated Value</p>
                        <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white">$0.00</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="attributes" className="space-y-4 md:space-y-6 mt-4 md:mt-6">
              <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                <CardHeader>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
                    <div className="p-3 md:p-4 border border-black/10 dark:border-white/10 rounded-lg bg-white/50 dark:bg-gray-800/50">
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Asset Type</p>
                      <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white">{assetTypeLabel}</p>
                    </div>
                    <div className="p-3 md:p-4 border border-black/10 dark:border-white/10 rounded-lg bg-white/50 dark:bg-gray-800/50">
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Token ID</p>
                      <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white">#{deedNFT.tokenId}</p>
                    </div>
                    <div className="p-3 md:p-4 border border-black/10 dark:border-white/10 rounded-lg bg-white/50 dark:bg-gray-800/50">
                    ...
                    {deedNFT.configuration && (
                      <div className="p-3 md:p-4 border border-black/10 dark:border-white/10 rounded-lg bg-white/50 dark:bg-gray-800/50">
                        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400">Configuration</p>
                        <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white break-all">{deedNFT.configuration}</p>
                      </div>
                    )}
                    {metadata?.attributes && metadata.attributes
                      ...
                      .map((attr, index) => (
                        <div key={index} className="p-3 md:p-4 border border-black/10 dark:border-white/10 rounded-lg bg-white/50 dark:bg-gray-800/50">
                          <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 truncate">{attr.trait_type}</p>
                          <p className="text-sm md:text-lg font-semibold text-gray-900 dark:text-white break-all">{String(attr.value)}</p>
                        </div>
                      ))}
                  </div>
                </CardContent>
            ...
            <TabsContent value="validation" className="space-y-4 md:space-y-6 mt-4 md:mt-6">
              <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                <CardHeader>
                ...
                <CardContent className="space-y-4 md:space-y-6">
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <Progress value={getValidationProgress()} className="h-2 md:h-3" />
                  </div>
                  {deedNFT.validatorAddress !== ethers.ZeroAddress && (
                    <div className="flex items-center justify-between">
                      <span className="text-sm md:text-base text-gray-600 dark:text-gray-300">Validator</span>
                      <div className="flex items-center space-x-2 min-w-0 flex-1">
                        <span className="text-gray-900 dark:text-white font-mono text-xs md:text-sm truncate">
            ...
            <TabsContent value="details" className="space-y-4 md:space-y-6 mt-4 md:mt-6">
              ...
              <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4 md:space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Asset Type</p>
                      <p className="text-sm md:text-base text-gray-900 dark:text-white font-medium">{assetTypeLabel}</p>
                    </div>
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Token ID</p>
                      <p className="text-sm md:text-base text-gray-900 dark:text-white font-medium">#{deedNFT.tokenId}</p>
                    </div>
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Owner</p>
                      <div className="flex items-center space-x-2">
                        <span className="text-gray-900 dark:text-white font-mono text-xs md:text-sm truncate flex-1">
                    ...
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Minted</p>
              ...
              <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4 md:space-y-6">
                  <div>
                    <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Definition</p>
                    <p className="text-sm md:text-base text-gray-900 dark:text-white">{deedNFT.definition}</p>
                  </div>
                  {deedNFT.configuration && (
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Configuration</p>
                      <p className="text-sm md:text-base text-gray-900 dark:text-white">{deedNFT.configuration}</p>
                    </div>
                  )}
                  {deedNFT.uri && (
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Metadata URI</p>
                      <div className="flex items-start space-x-2">
                        <p className="text-gray-900 dark:text-white font-mono text-xs md:text-sm break-all flex-1">
                          {deedNFT.uri}
                        </p>
                        <Button
                          variant="ghost"
              ...
              <Card className="border-black/10 dark:border-white/10 bg-white/90 dark:bg-[#141414]/90 backdrop-blur-sm">
                ...
                <CardContent className="space-y-4 md:space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Payment Token</p>
                    ...
                    <div>
                      <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-2">Salt</p>
                      <p className="text-sm md:text-base text-gray-900 dark:text-white font-medium">
                        {deedNFT.salt || "0"}
                      </p>
                    </div>
          ...
          {/* Actions */}
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 pt-4 md:pt-6">
            <Button
              variant="outline"
