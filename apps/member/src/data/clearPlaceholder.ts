...
export const THREADS: Thread[] = [
  {
    ...
    initials: 'CS',
    kind: 'support',
    subtitle: 'Case · October carry',
    preview: 'Credited the $18.80 back to your cycle',
    time: '9:12 AM',
    unread: true,
    context: { status: 'Answered', tone: 'settled', about: 'About · October carry', link: { label: 'See in Activity', to: '/activity' } },
  },
  {
    id: 'mikes-tire',
    name: "Mike's Tire",
    initials: 'MT',
    kind: 'partner',
    subtitle: 'Term plan · 2 of 4',
    preview: 'Your tyres are ready for pickup any time',
    time: 'Yesterday',
    context: { status: '2 of 4', tone: 'underway', about: 'Term plan · $940.00', link: { label: 'Manage plan', to: '/?do=term-plans' } },
  },
  {
    id: 'maria',
    name: 'Maria C.',
    ...
    kind: 'member',
    subtitle: '@mariac',
    preview: 'can you cover the $40 till friday?',
    time: 'Mon',
    unread: true,
    context: { status: 'Sent', tone: 'neutral', about: '$40.00 · Oct 26', link: { label: 'See in Activity', to: '/activity' } },
  },
  {
    id: 'tinybox',
    ...
    initials: 'TB',
    kind: 'partner',
    subtitle: 'Modular homes · Redlands',
    preview: 'Quote attached for the backyard unit',
    time: 'Oct 21',
    context: { status: 'Quoted', tone: 'neutral', about: 'No plan yet', link: { label: 'See partner', to: '/partners' } },
  },
  {
    id: 'diego',
    name: 'Diego R.',
    ...
    time: 'Oct 19',
    context: { status: 'Sent', tone: 'neutral', about: '$35.00 · Oct 19', link: { label: 'See in Activity', to: '/activity' } },
  },
];
...
export const INBOX: InboxData = {
  ...
  messages: {
    support: [
      {
        id: 'm1',
        body: 'Hi Kai. I have looked at the carry on your October cycle. The $18.80 was charged before your deposit landed, so I have credited it back.',
        time: '9:12 AM',
      },
      { id: 'm2', mine: true, body: 'Thanks. Will it show in Activity?', time: '9:14 AM' },
      { id: 'm3', body: 'Yes, as a credit dated today. It does not change your plan or your limit.', time: '9:15 AM' },
    ],
    'mikes-tire': [
      { id: 'k1', body: 'Your tyres are ready for pickup any time before 6.', time: 'Yesterday 4:02 PM' },
      { id: 'k2', mine: true, body: 'Great, I will come by tomorrow morning.', time: 'Yesterday 4:20 PM' },
    ],
    maria: [
      { id: 'r1', body: 'can you cover the $40 till friday?', time: 'Mon 7:41 PM' },
      { id: 'r2', mine: true, body: 'Sent. No rush.', time: 'Mon 7:43 PM' },
    ],
    tinybox: [{ id: 't1', body: 'Quote attached for the backyard unit.', time: 'Oct 21 11:05 AM' }],
    diego: [
      { id: 'd1', body: 'thanks, got it', time: 'Oct 19 6:12 PM' },
      { id: 'd2', mine: true, body: 'Anytime', time: 'Oct 19 6:15 PM' },
    ],
  },
};
...
export const ACTIVITY_IN_USE: ActivityData = {
  ...
  // The merchants behind those groups, for Change groups. Totals match the four figures above.
  merchants: [
    { name: 'Stater Bros', group: 'Groceries', payments: 3, amount: 212.34 },
    { name: 'Costco', group: 'Groceries', payments: 2, amount: 137.66 },
    { name: 'Orange St Market', group: 'Groceries', payments: 2, amount: 62 },
    { name: 'Verizon', group: 'Bills', payments: 1, amount: 85 },
    { name: 'SCE', group: 'Bills', payments: 1, amount: 96 },
    { name: 'Redlands Water', group: 'Bills', payments: 1, amount: 48 },
    { name: "Mike's Tire", group: 'Bills', payments: 1, amount: 56 },
    { name: 'Shell', group: 'Fuel', payments: 4, amount: 188 },
    { name: 'Chipotle', group: 'Everything else', payments: 3, amount: 64.2 },
    { name: 'Rincon Coffee', group: 'Everything else', payments: 5, amount: 41.5 },
    { name: 'TinyBox Systems', group: 'Everything else', payments: 1, amount: 180 },
    { name: 'Highland Supply', group: 'Everything else', payments: 2, amount: 246.75 },
    { name: 'Diego R.', group: 'Everything else', payments: 1, amount: 40 },
    { name: 'Vega Electric', group: 'Everything else', payments: 1, amount: 210 },
    { name: 'Cortez Plumbing', group: 'Everything else', payments: 1, amount: 92.55 },
    { name: 'Amazon', group: 'Everything else', payments: 4, amount: 61 },
    { name: 'Redlands Parking', group: 'Everything else', payments: 2, amount: 21 },
  ],
  cycleCount: 24,
  totalCount: 112,
