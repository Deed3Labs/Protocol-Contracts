...
export interface CreatorTokenBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface CreatorTokenBase extends BaseContract {
  connect(runner?: ContractRunner | null): CreatorTokenBase;
  waitForDeployment(): Promise<this>;

  interface: CreatorTokenBaseInterface;
