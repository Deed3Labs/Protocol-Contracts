...
export interface ERC721CInitializableInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "initializeERC721",
...
export interface ERC721CInitializable extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721CInitializable;
  waitForDeployment(): Promise<this>;

  interface: ERC721CInitializableInterface;
  ...
  initializeERC721: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "initializeERC721"
  ): TypedContractMethod<
    [name_: string, symbol_: string],
    [void],
    "nonpayable"
