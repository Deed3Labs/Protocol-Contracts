...
export interface IDeedNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_exists"
      | "approve"
...
export interface IDeedNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IDeedNFT;
  waitForDeployment(): Promise<this>;

  interface: IDeedNFTInterface;
  ...
  canSubdivide: TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;

  contractURI: TypedContractMethod<[], [string], "view">;

  getApproved: TypedContractMethod<[tokenId: BigNumberish], [string], "view">;

  getAssetType: TypedContractMethod<[tokenId: BigNumberish], [bigint], "view">;

  getDeedInfo: TypedContractMethod<
    [tokenId: BigNumberish],
    [
      [bigint, boolean, string, string, string, string] & {
        assetType: bigint;
        isValidated: boolean;
  ...
  isValidated: TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;
