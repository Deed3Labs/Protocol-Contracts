...
import type {
  ...
  ERC721CInitializableInterface,
} from "../../../../../../@limitbreak/creator-token-standards/src/erc721c/ERC721C.sol/ERC721CInitializable";
...
export class ERC721CInitializable__factory {
  static readonly abi = _abi;
  static createInterface(): ERC721CInitializableInterface {
    return new Interface(_abi) as ERC721CInitializableInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ERC721CInitializable;
  }
}
